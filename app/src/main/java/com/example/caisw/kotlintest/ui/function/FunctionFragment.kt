package com.example.caisw.kotlintest.ui.function
...
import com.example.caisw.kotlintest.ui.function.basics.packageDefine.PackageDefineFragment
import kotlinx.android.synthetic.main.fragment_function.*

/**
 * Created by caisw on 2018/1/10.
 */
open class FunctionFragment : BaseFragment() {

    companion object {
        val PACKAGE_DEFINE_FRAGMENT: FragmentData = FragmentData("包定义", PackageDefineFragment::class.java.name, FunctionFragment.createData("包定义"))
